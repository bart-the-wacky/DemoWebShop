...
WebUI.setText(findTestObject('Object Repository/demo_shop/input_First name_FirstName'), '')

WebUI.setText(findTestObject('Object Repository/demo_shop/input_Last name_LastName'), 'Prout')

WebUI.setText(findTestObject('Object Repository/demo_shop/input_Email_Email'), 'testprout5@yopmail.com')
...
WebUI.verifyElementPresent(findTestObject('demo_shop/span_First name is required.'), 0)

WebUI.verifyElementText(findTestObject('demo_shop/span_First name is required.'), 'First name is required.')
