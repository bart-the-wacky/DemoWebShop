...
WebUI.setText(findTestObject('Object Repository/demo_shop/input_Email_Email'), 'testprout1@yopmail.com')
...
WebUI.verifyElementPresent(findTestObject('demo_shop/li_The specified email already exists'), 0)

WebUI.verifyElementText(findTestObject('demo_shop/li_The specified email already exists'), 'The specified email already exists')
