...
WebUI.setText(findTestObject('Object Repository/demo_shop/input_Last name_LastName'), '')
...
WebUI.verifyElementPresent(findTestObject('demo_shop/span_Last name is required.'), 0)

WebUI.verifyElementText(findTestObject('demo_shop/span_Last name is required.'), 'Last name is required.')
